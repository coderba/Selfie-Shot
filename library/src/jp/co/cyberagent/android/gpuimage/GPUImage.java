...
import jp.co.cyberagent.android.gpuimage.util.ImageTool;
...
public class GPUImage {
    ...
    public void saveToPictures(final String folderName, final String fileName,
            final OnPictureSavedListener listener, Context context, AVLoadingIndicatorView avLoadingIndicatorView) {
        saveToPictures(mCurrentBitmap, folderName, fileName, listener, context, avLoadingIndicatorView );
    }
    ...
    public void saveToPictures(final Bitmap bitmap, final String folderName, final String fileName,
            final OnPictureSavedListener listener, final Context context, AVLoadingIndicatorView avLoadingIndicatorView) {
        new SaveTask(bitmap, folderName, fileName, listener, context, avLoadingIndicatorView).execute();
    }
    ...
    public class SaveTask extends AsyncTask<Void, Void, Void> {
        ...
        private final AVLoadingIndicatorView mAVLoadingIndicatorView;
        private final Context mContext;
        ...
        public SaveTask(final Bitmap bitmap, final String folderName, final String fileName,
            ...
            mContext= context;
            mAVLoadingIndicatorView= avLoadingIndicatorView;
        ...
        public void saveImage(final String folderName, final String fileName,final Bitmap image) {
            ...
            //image= ImageTool.getOrientation(file.getPath().toString(), image);

            try {
                file.getParentFile().mkdirs();
                FileOutputStream fileOutputStream= new FileOutputStream(file);
                //image= getOrientation(file.getPath().toString(), image);

                String[] orientationColumn = {MediaStore.Images.Media.ORIENTATION};
                Log.i("adasd", "ori column: "+ orientationColumn[0]);
                ...
                try {
                    ...
                    e.printStackTrace();
                    Log.i("asdasdasd", "error");
                }
                int orientation = exif.getAttributeInt( ExifInterface.TAG_ORIENTATION, ExifInterface.ORIENTATION_NORMAL);
                Log.i("asdadasdasd", "ORI: "+ orientation);
    ...
    public abstract class LoadImageTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        public Bitmap loadResizedImage() {
         ...
         */
        public int[] getScaleSize(int width, int height) {
            float newWidth;
            float newHeight;
        ...
        public boolean checkSize(boolean widthBigger, boolean heightBigger) {
            if (mScaleType == ScaleType.CENTER_CROP) {
        ...
        public Bitmap rotateImage(final Bitmap bitmap) {
            if (bitmap == null) {
                return null;
            }
