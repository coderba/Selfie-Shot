...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public MyHighlightView(ImageView context, int styleId, FeatherDrawable content, Context context_) {
        mContent = content;
        CONTEXT= context_;
        ...
        mAnchorRotate = CONTEXT.getResources().getDrawable(R.drawable.aviary_resize_knob);
        mAnchorDelete = CONTEXT.getResources().getDrawable(R.drawable.aviary_delete_knob);
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth((int)(0.5F + 1 * metrics.density));
