...
//        }
    ...
    public boolean onDown(MotionEvent e) {
        ...
        if (realNewSelection != null && mScaleWithContent) {
            ...
            Log.d("", "invalidSize: " + invalidSize);

            if (!invalidSize) {
                Log.w("", "drawable too small!!!");
                ...
                Log.d("", "minRectSize: " + minRectSize);

                float diff = minSize / minRectSize;

                Log.d("", "diff: " + diff);

                Log.d("", "min.size: " + minW + "x" + minH);
                Log.d("", "cur.size: " + displayRect.width() + "x" + displayRect.height());
                Log.d("", "zooming to: " + (getScale() * diff));
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        if (mOverlayView != null) {
            ...
            Log.d("", "selected items: " + mOverlayViews.size());
    ...
    protected void onZoomAnimationCompleted(float scale) {
        Log.i("", "onZoomAnimationCompleted: " + scale);
